...
6. Testing pada local
    - Ganti value port dan NRP
      ...
      ![](media/image4.1.1.png)

      Terlihat bahwa hasilnya sesuai karena menggagalkan 2 test.
    
    - Perbaiki value port dan NRP
      ![](media/image4.1.2.png)

      Gambar diatas merupakan hasil jika memenuhi semua tes.
...
4. Hasil 
    ...
    Hasil nya adalah sukses seperti pada gambar diatas. Dapat diakses pada link [ini](http://end-api-aydin.southeastasia.azurecontainer.io:3000/health)
